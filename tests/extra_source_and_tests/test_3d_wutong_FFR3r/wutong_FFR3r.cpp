...
Real fluid_radius_inlet = 0.0023068;
Real fluid_radius_outlet0 = 0.0009252;
Real fluid_radius_outlet1 = 0.0010570;
Real fluid_radius_outlet2 = 0.0010013;

//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_inlet = Vecd(resolution_ref * 2.5, 1.5 * fluid_radius_inlet, 1.5 * fluid_radius_inlet);
Vecd buffer_translation_inlet = Vecd(-0.0023989 + resolution_ref * 2.5, 0.0392886, 1.7932375);
Vecd normal_vector_inlet = Vecd(0.7934, 0.5793, -0.1868);
Vecd vector_inlet = Vecd(0, 0.3069, 0.9517);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet0 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet0, 2 * fluid_radius_outlet0);
Vecd buffer_translation_outlet0 = Vecd(0.0178491 + resolution_ref * 2.5, 0.0571845, 1.7754831);
Vecd normal_vector_outlet0 = Vecd(0.6905, -0.6674, 0.2788);
Vecd vector_outlet0 = Vecd(0, -0.3855, - 0.9227);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet1 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet1, 2 * fluid_radius_outlet1);
Vecd buffer_translation_outlet1 = Vecd(-0.0542795 + resolution_ref * 2.5, -0.0053889, 1.7596164);
Vecd normal_vector_outlet1 = Vecd(0.9992, -0.0316, -0.0264);
Vecd vector_outlet1 = Vecd(0, 0.6411, - 0.7674);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet2 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet2, 2 * fluid_radius_outlet2);
Vecd buffer_translation_outlet2 = Vecd(-0.0512650 + resolution_ref * 2.5, 0.0411923, 1.7521910);
Vecd normal_vector_outlet2 = Vecd(0.5832, -0.8123, 0);
...
//----------------------------------------------------------------------
BoundingBox system_domain_bounds(Vec3d(-0.06, -0.02, 1.7), Vec3d(0.04, 0.06, 1.8));
