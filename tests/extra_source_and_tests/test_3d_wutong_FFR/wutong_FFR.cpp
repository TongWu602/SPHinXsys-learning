...
std::string full_path_to_stl_file_wall = "./input/outwallnew.stl";
std::string full_path_to_stl_file_fluid = "./input/blood.stl";
//----------------------------------------------------------------------
//	Basic geometry parameters and numerical setup.
//----------------------------------------------------------------------
Real scale = 0.001;
Real resolution_ref = 0.0002; // buffer size 1.25mm
...
Vecd buffer_translation_inlet = Vecd(0.0121274 + resolution_ref * 3.5, -0.1415188, 0.5989114);
...
Vecd buffer_translation_outlet0 = Vecd(0.0388653 + resolution_ref * 5, -0.1153361, 0.5595398);
...
Vecd buffer_translation_outlet1 = Vecd(0.0419898 + resolution_ref * 7, -0.1662735, 0.5841138);
...
Vecd buffer_translation_outlet2 = Vecd(0.0596095 + resolution_ref * 6, -0.1364598, 0.5474117);
...
Vecd buffer_translation_outlet3 = Vecd(0.0544476 + resolution_ref * 5, -0.1323848, 0.5752564);
...
Vecd buffer_translation_outlet4 = Vecd(0.0289540, -0.1786469, 0.5438934);
...
//----------------------------------------------------------------------
BoundingBox system_domain_bounds(Vec3d(0.01, -0.185, 0.54), Vec3d(0.065, -0.110, 0.61));
