...
Real fluid_radius_inlet = 0.0024570;
Real fluid_radius_outlet0 = 0.0010502;
Real fluid_radius_outlet1 = 0.0009243;
Real fluid_radius_outlet2 = 0.0008600;
Real fluid_radius_outlet3 = 0.0009802;
Real fluid_radius_outlet4 = 0.0008335;
Real fluid_radius_outlet5 = 0.0010364;
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_inlet = Vecd(resolution_ref * 2.5, 1.5 * fluid_radius_inlet, 1.5 * fluid_radius_inlet);
Vecd buffer_translation_inlet = Vecd(-0.0004572 + resolution_ref * 2.5, 0.027904, 1.8156242);
Vecd normal_vector_inlet = Vecd(-0.9162, -0.2165, 0.3372);
Vecd vector_inlet = Vecd(0, -0.8415, -0.5403);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet0 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet0, 2 * fluid_radius_outlet0);
Vecd buffer_translation_outlet0 = Vecd(-0.0518726 + resolution_ref * 2.5, 0.0726976, 1.785911);
Vecd normal_vector_outlet0 = Vecd(0.3649, -0.3494, 0.8630);
Vecd vector_outlet0 = Vecd(0, -0.9269,- 0.3753);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet1 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet1, 2 * fluid_radius_outlet1);
Vecd buffer_translation_outlet1 = Vecd(-0.0631838 + resolution_ref * 2.5, 0.0401049, 1.8097838);
Vecd normal_vector_outlet1 = Vecd(0.6300, -0.4761, 0.6135);
Vecd vector_outlet1 = Vecd(0, -0.7900, - 0.6131);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet2 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet2, 2 * fluid_radius_outlet2);
Vecd buffer_translation_outlet2 = Vecd(-0.0368103 + resolution_ref * 2.5, 0.0134906, 1.8220076);
Vecd normal_vector_outlet2 = Vecd(1, 0, 0);
Vecd vector_outlet2 = Vecd(0, 0, 1);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet3 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet3, 2 * fluid_radius_outlet3);
Vecd buffer_translation_outlet3 = Vecd(-0.0347926 + resolution_ref * 2.5, -0.0013694, 1.8197469);
Vecd normal_vector_outlet3 = Vecd(0.6351, 0.7722, 0.0204);
Vecd vector_outlet3 = Vecd(0, - 0.0264, 0.9997);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet4 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet4, 2 * fluid_radius_outlet4);
Vecd buffer_translation_outlet4 = Vecd(-0.0640635 + resolution_ref * 2.5, -0.0081742, 1.7884919);
Vecd normal_vector_outlet4 = Vecd(0.6083, -0.6083, 0.5098);
Vecd vector_outlet4 = Vecd(0, 0 - 0.6423 ,- 0.7664);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet5 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet4, 2 * fluid_radius_outlet4);
Vecd buffer_translation_outlet5 = Vecd(-0.0358568 + resolution_ref * 2.5, -0.0196960, 1.7786496);
Vecd normal_vector_outlet5 = Vecd(0.1894, 0.0940, 0.9774);
Vecd vector_outlet5 = Vecd(0, -0.9954, 0.0957);
//---------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------
BoundingBox system_domain_bounds(Vec3d(-0.07, -0.03, 1.8), Vec3d(0.01, 0.08, 1.9));
