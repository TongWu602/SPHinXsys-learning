...
std::string full_path_to_stl_file_wall = "./input/outwall.stl";
std::string full_path_to_stl_file_fluid = "./input/blood.stl";
//----------------------------------------------------------------------
//	Basic geometry parameters and numerical setup.
//----------------------------------------------------------------------
Real scale = 0.0001;
Real fluid_radius_inlet = 0.0023154;
Real fluid_radius_outlet0 = 0.0010163;
Real fluid_radius_outlet1 = 0.0010052;
Real fluid_radius_outlet2 = 0.0009491;
Real fluid_radius_outlet3 = 0.0009190;
Real fluid_radius_outlet4 = 0.0007629;
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_inlet = Vecd(resolution_ref * 2.5, 1.5 * fluid_radius_inlet, 1.5 * fluid_radius_inlet);
Vecd buffer_translation_inlet = Vecd(0.0121274 + resolution_ref * 2.5, -0.1415188, 0.5989114);
Vecd normal_vector_inlet = Vecd(0.7505, 0.2628, 0.6064);
Vecd vector_inlet = Vecd(0, -0.9175, 0.3976);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet0 = Vecd(resolution_ref * 2.5, 1.5 * fluid_radius_outlet0, 1.5 * fluid_radius_outlet0);
Vecd buffer_translation_outlet0 = Vecd(0.0388653 + resolution_ref * 2.5, -0.1153361, 0.5595398);
Vecd normal_vector_outlet0 = Vecd(0.2249, -0.1716, 0.9592);
Vecd vector_outlet0 = Vecd(0, -0.9844, -0.1761);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet1 = Vecd(resolution_ref * 2.5, 1.5 * fluid_radius_outlet1, 1.5 * fluid_radius_outlet1);
Vecd buffer_translation_outlet1 = Vecd(0.0419898 + resolution_ref * 2.5, -0.1662735, 0.5841138);
Vecd normal_vector_outlet1 = Vecd(-0.0695, 0.5066, 0.8594);
Vecd vector_outlet1 = Vecd(0, -0.8615, 0.5078);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet2 = Vecd(resolution_ref * 2.5, 1.5 * fluid_radius_outlet2, 1.5 * fluid_radius_outlet2);
Vecd buffer_translation_outlet2 = Vecd(0.0596095 + resolution_ref * 2.5, -0.1364598, 0.5474117);
Vecd normal_vector_outlet2 = Vecd(0.2251, 0.0961, 0.9696);
Vecd vector_outlet2 = Vecd(0,-0.9951, 0.0986);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet3 = Vecd(resolution_ref * 2.5, 1.5 * fluid_radius_outlet3, 1.5 * fluid_radius_outlet3);
Vecd buffer_translation_outlet3 = Vecd(0.0544476 + resolution_ref * 2.5, -0.1323848, 0.5752564);
Vecd normal_vector_outlet3 = Vecd(-0.3057, -0.2902, 0.9068);
Vecd vector_outlet3 = Vecd(0, -0.9524, -0.3048);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet4 = Vecd(resolution_ref * 2.5, 1.5 * fluid_radius_outlet4, 1.5 * fluid_radius_outlet4);
Vecd buffer_translation_outlet4 = Vecd(0.0289540 + resolution_ref * 2.5, -0.1786469, 0.5438934);
Vecd normal_vector_outlet4 = Vecd(-0.6110, -0.4852, 0.6255);
Vecd vector_outlet4 = Vecd(0, -0.7901, -0.6129);
//---------------------------------------------------------------------------------------------------------------
...
//	Material parameters.
//----------------------------------------------------------------------
Real Outlet_pressure = 2666;
Real rho0_f = 1060.0;
Real mu_f = 3.6e-3;
Real U_f = 0.12;
Real c_f = 10.0 * U_f;

Real resolution_ref = 0.00025; //buffer size 1.25mm
//----------------------------------------------------------------------
//	Geometry parameters for shell.
//----------------------------------------------------------------------
BoundingBox system_domain_bounds(Vec3d(0.0, -0.2, 0.54), Vec3d(0.07, -0.1, 0.61));
