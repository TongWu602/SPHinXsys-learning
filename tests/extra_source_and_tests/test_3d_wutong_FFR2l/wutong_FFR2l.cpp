...
Real fluid_radius_inlet = 0.0025195;
Real fluid_radius_outlet0 = 0.0010074;
Real fluid_radius_outlet1 = 0.0010007;
Real fluid_radius_outlet2 = 0.0009521;
Real fluid_radius_outlet3 = 0.0009728;
Real fluid_radius_outlet4 = 0.0011348;
Real fluid_radius_outlet5 = 0.0009136;
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_inlet = Vecd(resolution_ref * 2.5, 1.5 * fluid_radius_inlet, 1.5 * fluid_radius_inlet);
Vecd buffer_translation_inlet = Vecd(-0.0109753 + resolution_ref * 2.5, 0.1683234, 1.6010487);
Vecd normal_vector_inlet = Vecd(-0.7985, -0.3520, 0.4883);
Vecd vector_inlet = Vecd(0, -0.8112, -0.5848);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet0 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet0, 2 * fluid_radius_outlet0);
Vecd buffer_translation_outlet0 = Vecd(-0.0426214 + resolution_ref * 2.5, 0.1906759, 1.5966515);
Vecd normal_vector_outlet0 = Vecd(0.0089, -0.5676, 0.8233);
Vecd vector_outlet0 = Vecd(0, -0.8233, -0.5676);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet1 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet1, 2 * fluid_radius_outlet1);
Vecd buffer_translation_outlet1 = Vecd(-0.0784482 + resolution_ref * 2.5, 0.1944563, 1.6017889);
Vecd normal_vector_outlet1 = Vecd(0.8137, -0.3607, 0.4559);
Vecd vector_outlet1 = Vecd(0, -0.7842, -0.6205);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet2 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet2, 2 * fluid_radius_outlet2);
Vecd buffer_translation_outlet2 = Vecd(-0.0874828 + resolution_ref * 2.5, 0.2220220, 1.5499829);
Vecd normal_vector_outlet2 = Vecd(0.3098, 0.2612, 0.9140);
Vecd vector_outlet2 = Vecd(0, -0.9615, 0.2748);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet3 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet3, 2 * fluid_radius_outlet3);
Vecd buffer_translation_outlet3 = Vecd(-0.0388996 + resolution_ref * 2.5, 0.1431214, 1.5446930);
Vecd normal_vector_outlet3 = Vecd(0.7622, 0.0080, 0.6472);
Vecd vector_outlet3 = Vecd(0, -0.9999, 0.0124);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet4 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet4, 2 * fluid_radius_outlet4);
Vecd buffer_translation_outlet4 = Vecd(-0.0969083 + resolution_ref * 2.5, 0.1742860, 1.5571980);
Vecd normal_vector_outlet4 = Vecd(0.2670, -0.7090, 0.6527);
Vecd vector_outlet4 = Vecd(0, -0.6773, -0.7357);
//---------------------------------------------------------------------------------------------------------------
Vecd buffer_halfsize_outlet5 = Vecd(resolution_ref * 2.5, 2 * fluid_radius_outlet4, 2 * fluid_radius_outlet4);
Vecd buffer_translation_outlet5 = Vecd(-0.1035755 + resolution_ref * 2.5, 0.1857143, 1.5721577);
Vecd normal_vector_outlet5 = Vecd(0.1728, -0.9414, 0.2895);
Vecd vector_outlet5 = Vecd(0, -0.2939, -0.9558);
//---------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------
BoundingBox system_domain_bounds(Vec3d(-0.12, 0.12, 1.54), Vec3d(0, 0.23, 1.62));
...
struct OutflowPressure3
{
    template <class BoundaryConditionType>
    OutflowPressure3(BoundaryConditionType &boundary_condition) {}
...
struct OutflowPressure4
{
    template <class BoundaryConditionType>
    OutflowPressure4(BoundaryConditionType &boundary_condition) {}
...
struct OutflowPressure5
{
    template <class BoundaryConditionType>
    OutflowPressure5(BoundaryConditionType &boundary_condition) {}
...
int main(int ac, char *av[])
{
    ...
    BodyAlignedBoxByCell disposer_outlet3(water_block, makeShared<AlignedBoxShape>(Transform(Rotation3d(std::acos(Eigen::Vector3d::UnitX().dot(-normal_vector_outlet3)), -vector_outlet3),
                                                                                             Vecd(buffer_translation_outlet3)),
                                                                                   buffer_halfsize_outlet3));
    SimpleDynamics<fluid_dynamics::DisposerOutflowDeletion> disposer_outflow_outlet3(disposer_outlet3, xAxis);

    BodyAlignedBoxByCell disposer_outlet4(water_block, makeShared<AlignedBoxShape>(Transform(Rotation3d(std::acos(Eigen::Vector3d::UnitX().dot(-normal_vector_outlet4)), -vector_outlet4),
                                                                                             Vecd(buffer_translation_outlet4)),
                                                                                   buffer_halfsize_outlet4));
    SimpleDynamics<fluid_dynamics::DisposerOutflowDeletion> disposer_outflow_outlet4(disposer_outlet4, xAxis);

    BodyAlignedBoxByCell disposer_outlet5(water_block, makeShared<AlignedBoxShape>(Transform(Rotation3d(std::acos(Eigen::Vector3d::UnitX().dot(-normal_vector_outlet5)), -vector_outlet5),
                                                                                             Vecd(buffer_translation_outlet5)),
                                                                                   buffer_halfsize_outlet5));
    SimpleDynamics<fluid_dynamics::DisposerOutflowDeletion> disposer_outflow_outlet5(disposer_outlet5, xAxis);
    ...
    BodyAlignedBoxByCell outflow_emitter3(water_block, makeShared<AlignedBoxShape>(Transform(Rotation3d(std::acos(Eigen::Vector3d::UnitX().dot(normal_vector_outlet3)), vector_outlet3),
                                                                                             Vecd(buffer_translation_outlet3)),
                                                                                   buffer_halfsize_outlet3));
    fluid_dynamics::BidirectionalBuffer<OutflowPressure3> outflow_injection3(outflow_emitter3, in_outlet_particle_buffer, xAxis);

    BodyAlignedBoxByCell outflow_emitter4(water_block, makeShared<AlignedBoxShape>(Transform(Rotation3d(std::acos(Eigen::Vector3d::UnitX().dot(normal_vector_outlet4)), vector_outlet4),
                                                                                             Vecd(buffer_translation_outlet4)),
                                                                                   buffer_halfsize_outlet4));
    fluid_dynamics::BidirectionalBuffer<OutflowPressure4> outflow_injection4(outflow_emitter4, in_outlet_particle_buffer, xAxis);

    BodyAlignedBoxByCell outflow_emitter5(water_block, makeShared<AlignedBoxShape>(Transform(Rotation3d(std::acos(Eigen::Vector3d::UnitX().dot(normal_vector_outlet5)), vector_outlet5),
                                                                                             Vecd(buffer_translation_outlet5)),
                                                                                   buffer_halfsize_outlet5));
    fluid_dynamics::BidirectionalBuffer<OutflowPressure5> outflow_injection5(outflow_emitter5, in_outlet_particle_buffer, xAxis);
    ...
    SimpleDynamics<fluid_dynamics::PressureCondition<OutflowPressure3>> outflow_pressure_condition3(outflow_emitter3);
    SimpleDynamics<fluid_dynamics::PressureCondition<OutflowPressure4>> outflow_pressure_condition4(outflow_emitter4);
    SimpleDynamics<fluid_dynamics::PressureCondition<OutflowPressure5>> outflow_pressure_condition5(outflow_emitter5);
    //----------------------------------------------------------------------
    ...
    outflow_injection3.tag_buffer_particles.exec();
    outflow_injection4.tag_buffer_particles.exec();
    outflow_injection5.tag_buffer_particles.exec();
    ...
    while (GlobalStaticVariables::physical_time_ < end_time)
    {
        ...
        while (integration_time < Output_Time)
        {
            ...
            outflow_injection3.injection.exec();
            outflow_injection4.injection.exec();
            outflow_injection5.injection.exec();

            disposer_outflow_inlet.exec();
            disposer_outflow_outlet0.exec();
            disposer_outflow_outlet1.exec();
            disposer_outflow_outlet2.exec();
            disposer_outflow_outlet3.exec();
            disposer_outflow_outlet4.exec();
            disposer_outflow_outlet5.exec();
