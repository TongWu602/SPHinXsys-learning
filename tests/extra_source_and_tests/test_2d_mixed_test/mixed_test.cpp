...
BoundingBox system_domain_bounds(Vec2d(-BW, -BW), Vec2d(DL + BW, 2*DH + BW));
Vec2d insert_circle_center = Vec2d(3 * DH, DH); // Location of the sinus center
Real N = 180;
//----------------------------------------------------------------------
//	Material parameters.
//----------------------------------------------------------------------
...
class WaterBlock : public MultiPolygonShape
{
  public:
    explicit WaterBlock(const std::string &shape_name) : MultiPolygonShape(shape_name)
    {
        ...
        {
            water_block_shape.push_back(Vecd(insert_circle_center[0] - DH * cos(i * Pi / N),
                                             insert_circle_center[1] +DH * sin(i * Pi / N)));
        }
        water_block_shape.push_back(Vecd(6 * DH, DH));
        water_block_shape.push_back(Vecd(6 * DH, 0.0));
        water_block_shape.push_back(Vecd(0.0, 0.0));
...
class WallBoundary : public MultiPolygonShape
{
  public:
    explicit WallBoundary(const std::string &shape_name) : MultiPolygonShape(shape_name)
    {
        ...
        outer_wall_shape.push_back(Vecd(2 * DH - BW, DH + BW));
        for (size_t i = 1; i < N; ++i)
        {
            outer_wall_shape.push_back(Vecd(insert_circle_center[0] - (DH + BW) * cos(i * Pi / N),
                                            insert_circle_center[1] + (DH + BW) * sin(i * Pi / N)));
        }
        outer_wall_shape.push_back(Vecd(4 * DH + BW, DH + BW));
        outer_wall_shape.push_back(Vecd(6 * DH, DH + BW));
        outer_wall_shape.push_back(Vecd(6 * DH, -BW));
        outer_wall_shape.push_back(Vecd(0.0, -BW));
        ...
        for (size_t i = 0; i < N + 1; ++i)
        {
            inner_wall_shape.push_back(Vecd(insert_circle_center[0] - DH * cos(i * Pi / N),
                                             insert_circle_center[1] + DH * sin(i * Pi / N)));
        }
        inner_wall_shape.push_back(Vecd(6 * DH, DH));
        inner_wall_shape.push_back(Vecd(6 * DH, 0.0));
        inner_wall_shape.push_back(Vecd(0.0, 0.0));
